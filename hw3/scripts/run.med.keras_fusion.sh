...
for event in P001 P002 P003; do
   for round_num in 0 1 2; do
      ...
      python train_svm_fusion.py ${event} ${round_num} ../avg_keras/ model/svm.avg_keras.${event}_${round_num}.model  #event_name round_num feat_dir output_file
      python validate_svm_fusion.py model/svm.avg_keras.${event}_${round_num}.model ../avg_keras/ ${event} ${round_num} pred/validation_keras_${event}_${round_num}    #model_file feat_dir event_name round_num output_file
   done
   echo " "
