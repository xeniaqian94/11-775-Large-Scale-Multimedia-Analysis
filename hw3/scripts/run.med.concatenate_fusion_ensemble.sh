...
for event in P001 P002 P003; do
   for round_num in 0 1 2; do
      ...
      python validate_svm_fusion.py model/svm.${method}.${event}_${round_num}.model ./${method}/ ${event} ${round_num} pred/validation_${method}_${event}_${round_num}    #model_file feat_dir event_name round_num output_file
   done
   echo " "
