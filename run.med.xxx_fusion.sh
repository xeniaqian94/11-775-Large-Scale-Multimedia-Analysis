...
method="asroutput_tedlium_complete_500_tf"
echo "#####################################"
...
for event in P001 P002 P003; do
   for round_num in 0 1 2; do
      ...
      python train_svm_fusion.py ${event} ${round_num} ./$method/ model/svm.$method.${event}_${round_num}.model  #event_name round_num feat_dir output_file
      python validate_svm_fusion.py model/svm.$method.${event}_${round_num}.model ./$method/ ${event} ${round_num} pred/validation_$method_${event}_${round_num}    #model_file feat_dir event_name round_num output_file
   done
   echo " "
